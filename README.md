...
- save the compiled program in an objectfile .o (write in inspector in "Output Object File")
- load the saved program from an objectfile .o (write in inspector in "Input Object File")
