...
- compile and run c-source-file just in time (filename *.c in inspector in "Source File")    
  new for v0.2: more than one filename separated with comma, the main-file first (for example "res://src/main.c,res://src/add.c" - the add.h is included in add.c - projects with modularization/OOP with structs no problem now )    
